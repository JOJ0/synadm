...
module that is worth mentioning and generating a module documentation for, is
the :code:`APIHelper` class which is the connection between the CLI code and the
